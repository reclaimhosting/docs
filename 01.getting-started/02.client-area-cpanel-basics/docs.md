...
By deafult, cPanel will put the **Files** section first on your dashboard. Note that you can change the order in which your tools appear in cPanel using the drag & drop method.
